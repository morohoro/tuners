...
config.job = { -- set to true (config.job = true) if you want all feature are accesible by any player, or true, required job to use repairs and upgrade menu, dyno -- job access for menu upgrade and points. ex. mechanic, tuner?
...
config.enableDegration = false -- enable / disable degration of engine parts
...
['elite'] = {category = 'oem', chance = 0}, -- ex. elite parts need x5 OEM
['pro'] =  {category = 'elite', chance = 0},
['racing'] =  {category = 'pro', chance = 0},
['ultimate'] =  {category = 'racing', chance = 0},
}
...
config.crafting = { -- crafting config and requires item
	...
	['etc'] = {
		...
		categories = {
			[1] = {
				items = {
					[1] = {name = 'turbostreet', label = 'Street Turbo', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[2] = {name = 'turbosports', label = 'Sports Turbo', requires = {steel = 20,aluminum = 20,iron = 20, rubber = 20}},
					[3] = {name = 'turboracing', label = 'Racing Turbo', requires = {steel = 40,aluminum = 40,iron = 40, rubber = 40}},
					[4] = {name = 'turboultimate', label = 'Ultimate Turbo', requires = {steel = 40,aluminum = 40,iron = 40, rubber = 40}},
				},
				label = 'Custom Turbos',
			},
			[2] = {
			...
			[3] = {
				items = {
					[1] = { label = 'Limited Slip Differential (Front)', name = 'lsdf' ,requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[2] = { label = 'Limited Slip Differential (Rear)', name = 'lsdr', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[3] = { label = 'Traction Control System', name = 'tcs', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[4] = { label = 'Stability Control System', name = 'esc', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[5] = { label = 'Close Ratio Gears', name = 'closerationgears', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[6] = { label = 'CVT Transmission', name = 'cvttranny', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[7] = { label = 'Anti-lock braking', name = 'abs', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[8] = { label = 'Axle Torsion (Front)', name = 'axletorsionfront', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[9] = { label = 'Axle Torsion (Rear)', name = 'axletorsionrear', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[10] = { label = 'Axle Solid (Front)', name = 'axlesolidfront', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[11] = { label = 'Axle Solid (Rear)', name = 'axlesolidrear', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[12] = { label = 'Kinetic Energy Recovery System (KERS)', name = 'kers', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[13] = { label = 'Offroad Tune 1', name = 'offroadtune1', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[14] = { label = 'Offroad Tune 2', name = 'offroadtune2', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[15] = { label = 'Stanced', name = 'stanced', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[16] = { label = 'Front Wheel Drive', name = 'frontwheeldrive', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[17] = { label = 'Rear Wheel Drive', name = 'rearwheeldrive', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[18] = { label = 'All Wheel Drive', name = 'allwheeldrive', requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
					[19] = { label = 'Programable ECU', name = 'ecu', requires = {chip = 1,board = 1,rubber = 10, steel = 10}},
			...
			[5] = {
				items = {
					[1] = {name = 'repairparts', label = 'Repair Engine Kit', durability = 100, requires = {steel = 10,aluminum = 10,iron = 10, rubber = 10}},
				},
